...
<section >
       ...
       <table>
        ...
        <td><form action="target_5_answer.php" method="post">
       ...
       <table class="border">
           　　<caption><?php print 'ターゲット_5 単語　範囲　'.$start.'~'.$end.'まで　　出題数　'.$length ?><?php print '     点数　 /'.$length?></caption>
               <tr class="border">
